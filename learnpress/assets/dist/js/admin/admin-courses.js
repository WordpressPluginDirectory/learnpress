...
class CreateCourseViaAI {
  ...
  init() {
    ...
    lpAssetsJsPath_utils_js__WEBPACK_IMPORTED_MODULE_0__.lpOnElementReady('.page-title-action', el => {
      el.insertAdjacentHTML('afterend', `<button type="button" class="lp-btn-generate-course-with-ai">
					<i class="lp-ico-ai"></i>
...
"use strict";
/*!**********************************************!*\
  !*** ./assets/src/js/admin/admin-courses.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
...
/******/ })()
;
//# sourceMappingURL=admin-courses.js.map